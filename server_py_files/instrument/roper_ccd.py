...
for the same reason - the trigger mode is read-only through pvcam (guessing micromanager uses
the pvcam dll) 3) through activex manipulation of the winview application
"""
...
class Princeton_CCD(glab_instrument.Glab_Instrument):
    ...
    def __del__(self):
        ...
        self.appdoc.Close()
        self.app.Stop()
        glab_instrument.Glab_Instrument.__del__(self)
...
#devlabel = 'Camera'
#
#DEVICE = [devlabel, 'PrincetonInstruments', 'Camera-1']
...
#
#print mmc.getDevicePropertyNames(devlabel)
#print "Temp Set at: ",  mmc.getProperty(devlabel,'CCDTemperatureSetPoint')
#mmc.setProperty(devlabel,'CCDTemperatureSetPoint','3')
#print "Temp Set at: ",  mmc.getProperty(devlabel,'CCDTemperatureSetPoint')
#
#def snap_show():
#    mmc.snapImage()
...
#    return img
#    
#def attempt_triggered_snap():
#    N_imgs=1
#    mmc.setProperty(devlabel,'Exposure','100')
#    mmc.setProperty(devlabel,"ExposureMode","Trigger_First_Mode")
#    #mmc.setProperty(devlabel,'TriggerMode', 'ExternalStrobed')   
#    mmc.initializeCircularBuffer()
#    mmc.startSequenceAcquisition(devlabel,N_imgs,10,0)
#    sleep(3)
#    mmc.stopSequenceAcquisition(devlabel)
...
#    def __init__(self):
#        if os.name == "nt":
#            print 'loading pvcam binaries'
#            WinDLL.__init__(self, "C:\\Program Files\\Roper Scientific\\WinView32\\pvcam32.dll") # TODO check it works
#        else:
...
#
#
#class PVCam():  #used to inherit model.DigitalCamera
#    """
...
#
#        print "Initial Temperature Setpoint: ", self.get_param(pv.PARAM_TEMP_SETPOINT)
#        print "Initial Temperature: ", self.get_param(pv.PARAM_TEMP)        
#        self.set_param(pv.PARAM_TEMP_SETPOINT,20)
#        print "New Temperature Setpoint: ", self.get_param(pv.PARAM_TEMP_SETPOINT)
#        print "Initial Exposure Mode: ", self.get_param(pv.PARAM_EXPOSURE_MODE)
#        pdb.set_trace()
#        self.set_param(pv.PARAM_EXPOSURE_MODE,2)
#
##
